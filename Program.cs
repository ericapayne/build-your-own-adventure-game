...
namespace ChooseYourOwnAdventure
{
  class Program
  {
      static void Main(string[] args)
    {
      ...
      //ternary condition chain for noiseChoice
    //   (noiseChoice = "NO") ? Console.WriteLine("Not much of an adventure if we don't leave our room! THE END.") : (noiseChoice = "YES") ? Console.WriteLine("You walk into the hallway and see a light coming from under a door down the hall. You walk towards it. Do you open it or knock?") : Console.WriteLine("Enter a valid answer");
